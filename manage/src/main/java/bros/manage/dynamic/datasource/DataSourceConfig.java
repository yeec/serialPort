...
//        String databaseUrl = "jdbc:oracle:thin:@(description=(address=(protocol=tcp)(port="+defaultDBPort+")(host="+defaultDBIp+"))(connect_data=(service_name="+defaultDBSvrName+")))";
        String databaseUrl = "jdbc:oracle:thin:@(description=(address_list=(address=(protocol=tcp)(port="+defaultDBPort+")(host="+defaultDBIp+")))(connect_data=(service_name="+defaultDBSvrName+")))";

...
public class SerialParameters {
   ...
   */
   ...
   //用于记录参数值 2018.05.09 新增
   public String toString() {
      return "[portName=" + portName + ", baudRate=" + baudRate + ", flowControlIn=" + flowControlIn
            + ", flowControlOut=" + flowControlOut + ", databits=" + databits + ", stopbits=" + stopbits + ", parity="
            + parity + "]";
   }

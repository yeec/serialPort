            ...
            {  
              ...
              {  
                ...
                {  
                  ...
                  if (value != null) 
                  {  
                    value = MetaObject.forObject(value,SystemMetaObject.DEFAULT_OBJECT_FACTORY, SystemMetaObject.DEFAULT_OBJECT_WRAPPER_FACTORY,null).getValue(propertyName.substring(prop.getName().length()));  
                  }  
                } 
                else 
                {  
